...
public class UserProfile
{
    ...
    public UserProfile(ParameterUserProfile parameterUserProfile)
    {
    ...
    public UserProfile(String user_name, String user_id, String user_phone_number, String user_email_id, String user_profile_pic_url, String status)
    {
