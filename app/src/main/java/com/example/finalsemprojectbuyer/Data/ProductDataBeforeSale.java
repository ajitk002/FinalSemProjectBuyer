...
public class ProductDataBeforeSale implements Serializable
{
    ...
    public ProductDataBeforeSale()
    {

    }

    public ProductDataBeforeSale(String product_ID, String product_seller_ID, String product_name, String product_condition, String product_usage_duration, String product_company, String product_categories, String product_description, String product_address, String product_payment_mode, String product_location_longitude, String product_location_latitude, String product_price, String product_pick_up_key, String product_picture_url, String product_upi_id, String product_date_of_sale, String product_address_pin)
    {
    ...
    public ProductDataBeforeSale(ParameterProductDataBeforeSale pdp)
    {
        product_ID = pdp.product_ID;
        product_seller_ID = pdp.product_seller_ID;
        product_name = pdp.product_name;
        product_categories = pdp.product_categories;
        product_company = pdp.product_company;
        product_description = pdp.product_description;
        product_usage_duration = pdp.product_original_date_of_purchase;
        product_address = pdp.product_address;
        product_payment_mode = pdp.product_payment_mode;
        product_location_longitude = pdp.product_location_longitude;
        product_location_longitude = pdp.product_location_latitude;
        product_price = pdp.product_price;
        product_pick_up_key = pdp.product_pick_up_key;
        product_picture_url = pdp.product_picture_url;
        product_condition = pdp.product_condition;
        product_upi_id = pdp.product_UpiId;
    }
