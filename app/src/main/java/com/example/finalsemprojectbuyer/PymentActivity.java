...
public class PymentActivity extends AppCompatActivity
{
    ...
    void setUpViews()
    {
        ...
        amountEt.setText(intent.getStringExtra("amount"));
        noteEt.setText(intent.getStringExtra("note"));
        nameEt.setText(intent.getStringExtra("name"));
        upiIdEt.setText(intent.getStringExtra("upi"));

//        amountEt.setText("100");
//        noteEt.setText("test");
//        nameEt.setText("Abhijith");
//        upiIdEt.setText("8217629625@ybl");
    }
