...
import com.example.finalsemprojectbuyer.billing.TransactionInvoice;
...
public class ProfileActivity extends AppCompatActivity
{
    ...
    private Button btnLogout, btnUpdateProfile, changePassWord, btn_bill;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        btn_bill.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                startActivity(new Intent(getApplicationContext(), TransactionInvoice.class));
            }
        });
